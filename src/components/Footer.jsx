    ...
    <>
      ...
      <footer className="p-8 mx-auto bg-slate-50 flex">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center md:justify-betweent">
              <Image src={logo} alt="EFICAP" width={150} className='pt-3' />
          ...
          <div className="flex space-x-4 mt-8 md:my-auto">
              <Link href="mailto:eficap@eficap.com.ar" target="_blank"><Image src={mail} alt='mail logo' width={30} /></Link>
              <Link href="https://wa.me/+5491535253017?text=Buenas!+me+contacto+desde+la+página+web" target="_blank"><Image src={wpp} alt='mail logo' width={28} /></Link>
              <Link href="https://twitter.com/ServicioEficap?t=fnRzqzdXx4yV#q3h68NHw&s=09" target="_blank"><Image src={twitter} alt='mail logo' width={30} /></Link>
              <Link href="tel:49244466" target="_blank"><Image src={call} alt='mail logo' width={33} /></Link>
            </div>
        </div>
      </footer>
    </>
