      ...
      <main className='bg-slate-50'>
        <div className='py-20'>
          <section className='grid grid-cols-1 grid-rows-2 lg:grid-cols-2 lg:grid-rows-1 justify-center items-center w-11/12 mx-auto pb-6'>
            <div>
              <p className='text-primaryColor text-sm md:text-xl lg:text-lg xl:text-2xl flex text-center justify-center items-center lg:mt-6'><Image loading='lazy' src={sobre} alt='icono sobre' width={35} className='mr-1' />Dejanos tu mensaje y será respondido a la brevedad</p>
              <Form />
            </div>
            <div className='mx-auto w-11/12'>
              <h2 className='text-primaryColor font-bold text-2xl lg:text-3xl uppercase lg:pt-0 mb-2'>información</h2>
              <p className='flex py-2 text-lg lg:text-lg xl:text-2xl'><Image loading='lazy' src={wpp} alt='whatsapp logo' width={25} /><Link href="mailto:eficap@eficap.com.ar " target="_blank" className='pl-2 font-light hover:text-primaryColor' rel="noopener noreferrer">eficap@eficap.com.ar</Link></p>
              <p className='flex py-2 text-lg lg:text-lg xl:text-2xl'><Image loading='lazy' src={wpp} alt='whatsapp logo' width={25} /><Link href="tel:1535253017" className='pl-2 font-light hover:text-primaryColor' rel="noopener noreferrer">153-525-3017</Link></p>
              <p className='flex py-2 lg:pb-4 xl:pb-10 text-lg lg:text-lg xl:text-2xl '><Image loading='lazy' src={wpp} alt='whatsapp logo' width={25} /><Link href="tel:49244466" className='pl-2 font-light hover:text-primaryColor'>4924-4466</Link></p>
